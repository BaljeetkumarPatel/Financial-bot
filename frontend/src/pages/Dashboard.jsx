...
export default function Dashboard({ user }) {
  ...
  return (
    ...
    <Footer />
    {/* Floating RAG Assistant Bot */}
    <motion.button
      onClick={() => navigate("/rag-assistant")}
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#072146] text-white rounded-full shadow-xl flex items-center justify-center hover:bg-[#1FA2B6] transition-colors"
      whileHover={{ scale: 1.1 }}
      whileTap={{ scale: 0.95 }}
      title="Finance Knowledge Assistant"
    >
      <BookOpen size={24} />
    </motion.button>
    </>
